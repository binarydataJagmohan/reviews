            ...
            <div className="row">
              <div className="col-sm-6">
                <div className="user-pro">
                  <a href="#" className="edit-img"><img src="/assets/images/user.png" alt="user" className="user" /> <i className="fa-solid fa-user-pen" /></a> 
                </div>
              </div>
          ...
          <div className="container"> 
            ...
            <div className="main_box mt-4">
              <div className="row">
                ...
                <div className="col-sm-4 col-5 text-right ">
                  <div className="del-icon"><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i className="fa-solid fa-trash" /></a></div>  
                  {/* Modal */}
                    ...
                    <div className="modal-dialog">
                      <div className="modal-content">
                        ...
                        <div className="modal-body pop-des">
                          ...
                          <p> If deleted, this review will not be able to be recovered. Deleting reviews does not impact your bungee score. </p>
                        </div>
                        <div className="modal-footer j-cebter">
                          <button type="button" className="btn edit-btn  Save changes" data-bs-dismiss="modal">Yes</button>
                          <button type="button" className="btn edit-btn  Cancel">No</button>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="main_box mt-5">
              <div className="row">
                ...
                <div className="col-sm-4 col-5 text-right ">
                  <div className="del-icon"><a href="#"><i className="fa-solid fa-trash" /></a></div>
                </div> 
              </div>
